      ...
      <div className={styles.container}>
        <div className={styles.headerBar}>
          ...
          <p>
            ...
            our hand-picked collection of premium names available for immediate
            purchase
          </p>
          ...
          <div className={styles.cardContainer}>
            <div className={styles.card}>
              ...
              <p>
                ...
                of business name ideas from world's largest community of naming
            ...
            <div className={styles.card}>
              ...
              <p>
                ...
                your target demographics to get unbiased feedback on your
                favorite names. Also receive Trademark support from our team of
                Licensed Trademark Attorneys, so you can pick your name with
                confidence.
              </p>
            </div>
          </div>
